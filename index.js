...
class TimerWrapper extends React.Component {
  ...
  class TimerDisplay extends React.Component {
    render() {
      ...
      if (this.props.timeLeft >= 5) {
        return <h1>Осталось {this.props.timeLeft} секунд</h1>
      }
      else if (this.props.timeLeft >= 2) {
        return <h1>Осталось {this.props.timeLeft} секунды</h1>
      }
      else if (this.props.timeLeft === 1) {
        return <h1>Осталось {this.props.timeLeft} секунда</h1> 
      } 
    }
  }
